...
@implementation YJIJKBrightnessView

+ (instancetype)sharedBrightnessView {
    static YJIJKBrightnessView *instance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[YJIJKBrightnessView alloc] init];
...
- (instancetype)init {
    if (self = [super init]) {
        ...
        self.backImage = ({
            ...
            imgView.image        = [UIImage yjijk_imageNamed:@"brightness"];
