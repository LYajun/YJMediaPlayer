...
//! Project version number for YJIJKMaterialDesignSpinner.
FOUNDATION_EXPORT double YJIJKMaterialDesignSpinnerVersionNumber;

//! Project version string for YJIJKMaterialDesignSpinner.
FOUNDATION_EXPORT const unsigned char YJIJKMaterialDesignSpinnerVersionString[];
 ...
 */
@interface YJIJKMaterialDesignSpinner : UIView
