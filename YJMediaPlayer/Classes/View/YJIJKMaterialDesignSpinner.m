...
static NSString *kYJIJKRingStrokeAnimationKey = @"yjijkmaterialdesignspinner.stroke";
static NSString *kYJIJKRingRotationAnimationKey = @"yjijkmaterialdesignspinner.rotation";

@interface YJIJKMaterialDesignSpinner ()
@property (nonatomic, readonly) CAShapeLayer *progressLayer;
@property (nonatomic, readwrite) BOOL isAnimating;
@end

@implementation YJIJKMaterialDesignSpinner
...
- (void)startAnimating {
    ...
    [self.progressLayer addAnimation:animation forKey:kYJIJKRingRotationAnimationKey];
    ...
    [self.progressLayer addAnimation:animations forKey:kYJIJKRingStrokeAnimationKey];
...
- (void)stopAnimating {
    ...
    [self.progressLayer removeAnimationForKey:kYJIJKRingRotationAnimationKey];
    [self.progressLayer removeAnimationForKey:kYJIJKRingStrokeAnimationKey];
