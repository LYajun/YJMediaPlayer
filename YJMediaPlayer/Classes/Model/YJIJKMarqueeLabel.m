...
@interface YJIJKMarqueeLabel ()<UIScrollViewDelegate>{
    NSTimer *_timer;
...
@end
@implementation YJIJKMarqueeLabel
...
-(void)commonInit{
    self.marqueeLabelType = YJIJKMarqueeLabelTypeLeft;
...
-(void)drawTextInRect:(CGRect)rect {
    ...
    if (self.marqueeLabelType == YJIJKMarqueeLabelTypeLeft) {
